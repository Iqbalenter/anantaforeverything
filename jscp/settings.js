...
const musicOptions = [
  ...
  { value: "./music/ThankGodIFoundYou.mp3", label: "Happy Birthday (Mèo UIA)" },
...
async function loadWebsiteFromServer() {
  ...
  try {
    ...
    const result =
      await window.birthdayAPI.getBirthdayWebsiteByWebsiteId(websiteId);
    ...
    if (result.success && result.data) {
      ...
      window.settings = {
        music: serverSettings.music || "./music/ThankGodIFoundYou.mp3",
